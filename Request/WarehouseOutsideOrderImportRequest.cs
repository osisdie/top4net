...
namespace Top.Api.Request
{
    ...
    public class WarehouseOutsideOrderImportRequest : ITopRequest<WarehouseOutsideOrderImportResponse>
    {
        ...
        /// <summary>
        /// json格式的货物列表，形式如：{"goods_list":[{"goods_name":"name","single_price":"100","goods_quantity":"10","outer_id":"abcd"},{"goods_name":"name1","single_price":"101","goods_quantity":"11","outer_id":"abcd1"}]}其中只有outer_id是可选的，outer_id可以  根据接口taobao.warehouse.items.get得到
        /// </summary>
        ...
        /// 收货人邮编
        /// </summary>
        public Nullable<long> ReceiverZipCode { get; set; }
